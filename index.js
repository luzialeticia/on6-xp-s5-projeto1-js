...
const resultado = (media >= 7) ? `Aprovade` : `Reprovade`

// condição ? true : false

console.log(`A estudande foi ${resultado}.`);
...
console.log(`Capturei o pokemon ${name}, do tipo ${type} e tem alura de ${height}cm.`)
...
const nascimento = new Date(1989, 0, 27)
...
const pessoa3 = new Pessoa('Leticia', 'Furtado', 31)
...
const pessoa4 = new Pessoa('Juliana', 'Furtado', 25, true, 500)
